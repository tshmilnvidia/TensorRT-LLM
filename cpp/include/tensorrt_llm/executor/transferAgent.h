...
public:
    ...
    virtual int registerMemory(MemoryDescs const& descs) = 0;
    virtual int deregisterMemory(MemoryDescs const& descs) = 0;
    virtual int registerFiles(FileDescs const& descs) = 0;
    virtual int deregisterFiles(FileDescs const& descs) = 0;
