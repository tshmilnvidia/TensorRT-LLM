...
public:
    ...
    virtual int registerMemory(MemoryDescs const& descs) override;
    virtual int deregisterMemory(MemoryDescs const& descs) override;
    virtual int registerFiles(FileDescs const& descs) override;
    virtual int deregisterFiles(FileDescs const& descs) override;
